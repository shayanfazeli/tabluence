...
class ZScoreSingleSliceNormalization(DataSideNormalizationBase):
    """
    :cls:`ZScoreSingleSliceNormalization` is the class for z-score normalization of single slice data.
    ...
    def __init__(self, **kwargs):
        ...
        Constructor
        """
        super(ZScoreSingleSliceNormalization, self).__init__(**kwargs)
